import{o as _}from"./qaOq6dvW.js";import{T as p,R as d,ak as b,av as f}from"./iNqZ71Tl.js";const y={token_processing_instruction:1,token_doctype:1,token_cdata:1,token_punctuation:1,token_tag:2,token_constant:2,token_symbol:2,token_deleted:2,token_keyword:2,token_null:2,token_boolean:2,token_interpolation_punctuation:2,token_heading:2,token_heading_punctuation:2,token_tag_punctuation:2,token_comment:3,token_char:3,token_inserted:3,token_blockquote:3,token_blockquote_punctuation:3,token_builtin:4,token_class_name:4,token_number:4,token_attr_value:5,token_attr_quote:5,token_string:5,token_template_punctuation:5,token_inline_code:5,token_code_punctuation:5,token_attr_equals:6,token_selector:7,token_function:7,token_regex:7,token_important:7,token_variable:7,token_atrule:8,token_attr_name:9,token_property:9,token_decorator:9,token_decorator_name:9,token_link_text_wrapper:9,token_link_text:9,token_link_punctuation:9,token_special_keyword:10,token_namespace:10,token_rule:10,token_at_keyword:11,token_url:11,token_strikethrough:13,token_bold:14,token_italic:15},g=()=>!!(globalThis.CSS?.highlights&&globalThis.Highlight),k=()=>typeof globalThis.StaticRange=="function"?"static":"live",x=s=>{for(const e of s.childNodes)if(e.nodeType===Node.TEXT_NODE)return e;return null},w=(s,e,t)=>{const n=s.get(e);n?n.push(t):s.set(e,[t])},u=new WeakMap,v=s=>{let e=u.get(s);if(e===void 0){e=[`token_${s.name}`];for(const t of s.aliases)e.push(`token_${t}`);u.set(s,e)}return e};class ${element_ranges;#e;constructor(){if(!g())throw Error("CSS Highlights API not supported");this.element_ranges=new Map,this.#e=k()}highlight_from_lexed(e,t){this.clear_element_ranges();const n=x(e);if(!n){t.events_len>0&&console.error("[HighlightManager] tokens present but no text node to highlight");return}try{this.#t(n,t)}catch(o){if(this.#e==="static")this.#e="live",this.clear_element_ranges(),this.#t(n,t);else throw o}}#t(e,t){const n=new Map;this.#s(t,e,n);for(const[o,l]of n){this.element_ranges.set(o,l);let i=CSS.highlights.get(o);i||(i=new Highlight,i.priority=y[o]??0,CSS.highlights.set(o,i));for(const r of l)i.add(r)}}clear_element_ranges(){for(const[e,t]of this.element_ranges){const n=CSS.highlights.get(e);if(n){for(const o of t)n.delete(o);n.size===0&&CSS.highlights.delete(e)}}this.element_ranges.clear()}destroy(){this.clear_element_ranges()}#o(e,t,n){if(this.#e==="static")return new StaticRange({startContainer:e,startOffset:t,endContainer:e,endOffset:n});const o=new Range;return o.setStart(e,t),o.setEnd(e,n),o}#s(e,t,n){const{events:o,events_len:l}=e,{infos:i}=e.types,r=t.textContent?.length??0,c=[];let a=0;for(;a<l;){const m=o[a];if(m>0)this.#n(i[m],o[a+1],o[a+2],t,n,r),a+=3;else if(m<0)c.push({id:-m,start:o[a+1]}),a+=2;else{const h=c.pop();h&&this.#n(i[h.id],h.start,o[a+1],t,n,r),a+=2}}}#n(e,t,n,o,l,i){const r=n>i?i:n;if(r<=t)return;const c=this.#o(o,t,r);for(const a of v(e))w(l,a,c)}}class E{#e;#t;#o;#s=p(()=>{const e=this.#e.lang();return e!==null&&this.#e.syntax_styler().has_lang(e)});#n=p(()=>this.#e.lang()===null||!d(this.#s));get highlighting_disabled(){return d(this.#n)}set highlighting_disabled(e){b(this.#n,e)}#i=p(()=>{if(!this.#t||!this.#o()||this.highlighting_disabled)return null;const e=this.#e.text();return e?this.#e.syntax_styler().lex(e,this.#e.lang()):null});constructor(e){this.#e=e,this.#o=e.enabled??(()=>!0);const t=this.#t=g()?new $:null;t&&f(()=>{const n=e.element();if(!n||!d(this.#i)){t.clear_element_ranges();return}t.highlight_from_lexed(n,d(this.#i))}),_(()=>t?.destroy())}}const H={json_complex:{name:"json_complex",lang:"json",content:`{
	"string": "a string",
	"number": 12345,
	"boolean": true,
	"null": null,
