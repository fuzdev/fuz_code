import{o as _}from"./Dz4nm9hr.js";import{at as b,x as r,y as d}from"./CHdRsJLz.js";const T={json_complex:{name:"json_complex",lang:"json",content:`{
	"string": "a string",
	"number": 12345,
	"boolean": true,
	"null": null,
...
binary=2#1010
decimal=42
`}},f={token_processing_instruction:1,token_doctype:1,token_cdata:1,token_punctuation:1,token_tag:2,token_constant:2,token_symbol:2,token_deleted:2,token_keyword:2,token_null:2,token_boolean:2,token_interpolation_punctuation:2,token_heading:2,token_heading_punctuation:2,token_tag_punctuation:2,token_comment:3,token_char:3,token_inserted:3,token_blockquote:3,token_blockquote_punctuation:3,token_builtin:4,token_class_name:4,token_number:4,token_attr_value:5,token_attr_quote:5,token_string:5,token_template_punctuation:5,token_inline_code:5,token_code_punctuation:5,token_attr_equals:6,token_selector:7,token_function:7,token_regex:7,token_important:7,token_variable:7,token_atrule:8,token_attr_name:9,token_property:9,token_decorator:9,token_decorator_name:9,token_link_text_wrapper:9,token_link_text:9,token_link_punctuation:9,token_special_keyword:10,token_namespace:10,token_rule:10,token_at_keyword:11,token_url:11,token_strikethrough:13,token_bold:14,token_italic:15},g=()=>!!(globalThis.CSS?.highlights&&globalThis.Highlight),k=()=>typeof globalThis.StaticRange=="function"?"static":"live",y=n=>{for(const e of n.childNodes)if(e.nodeType===Node.TEXT_NODE)return e;return null},x=n=>n.some(e=>typeof e!="string"),p=(n,e,o)=>{const t=n.get(e);t?t.push(o):n.set(e,[o])};class w{element_ranges;#e;constructor(){if(!g())throw Error("CSS Highlights API not supported");this.element_ranges=new Map,this.#e=k()}highlight_from_syntax_tokens(e,o){this.clear_element_ranges();const t=y(e);if(!t){x(o)&&console.error("[HighlightManager] tokens present but no text node to highlight");return}try{this.#t(t,o)}catch(a){if(this.#e==="static")this.#e="live",this.clear_element_ranges(),this.#t(t,o);else throw a}}#t(e,o){const t=new Map;this.#n(o,e,t,0);for(const[a,l]of t){this.element_ranges.set(a,l);let s=CSS.highlights.get(a);s||(s=new Highlight,s.priority=f[a]??0,CSS.highlights.set(a,s));for(const i of l)s.add(i)}}clear_element_ranges(){for(const[e,o]of this.element_ranges){const t=CSS.highlights.get(e);if(t){for(const a of o)t.delete(a);t.size===0&&CSS.highlights.delete(e)}}this.element_ranges.clear()}destroy(){this.clear_element_ranges()}#o(e,o,t){if(this.#e==="static")return new StaticRange({startContainer:e,startOffset:o,endContainer:e,endOffset:t});const a=new Range;return a.setStart(e,o),a.setEnd(e,t),a}#n(e,o,t,a){const l=o.textContent?.length??0;let s=a;for(const i of e){if(typeof i=="string"){s+=i.length;continue}const c=s+i.length,h=c>l?l:c;if(h>s){const m=this.#o(o,s,h);p(t,`token_${i.type}`,m);for(const u of i.alias)p(t,`token_${u}`,m)}Array.isArray(i.content)&&this.#n(i.content,o,t,s),s=c}return s}}const S=n=>{const e=g()?new w:null,o=n.enabled??(()=>!0),t=d(()=>n.lang()!==null&&!!n.syntax_styler().langs[n.lang()]),a=d(()=>n.lang()===null||!r(t)&&!n.grammar()),l=d(()=>{if(!e||!o()||r(a))return null;const s=n.text();return s?n.syntax_styler().tokenize(s,n.lang(),n.grammar()):null});return e&&b(()=>{const s=n.element();if(!s||!r(l)){e.clear_element_ranges();return}e.highlight_from_syntax_tokens(s,r(l))}),_(()=>e?.destroy()),{get highlighting_disabled(){return r(a)}}};export{g as a,S as c,T as s};
