import{V as e,Y as t,lt as n,n as r}from"./dl1uVvpj.js";var i=[`json`,`css`,`ts`,`html`,`svelte`,`md`,`bash`],a={json_complex:{name:`json_complex`,lang:`json`,content:`{
	"string": "a string",
	"number": 12345,
	"boolean": true,
	"null": null,
...
binary=2#1010
decimal=42
`}},o={token_processing_instruction:1,token_doctype:1,token_cdata:1,token_punctuation:1,token_tag:2,token_constant:2,token_symbol:2,token_deleted:2,token_keyword:2,token_null:2,token_boolean:2,token_interpolation_punctuation:2,token_heading:2,token_heading_punctuation:2,token_tag_punctuation:2,token_comment:3,token_char:3,token_inserted:3,token_blockquote:3,token_blockquote_punctuation:3,token_builtin:4,token_class_name:4,token_number:4,token_attr_value:5,token_attr_quote:5,token_string:5,token_template_punctuation:5,token_inline_code:5,token_code_punctuation:5,token_attr_equals:6,token_selector:7,token_function:7,token_regex:7,token_important:7,token_variable:7,token_atrule:8,token_attr_name:9,token_property:9,token_decorator:9,token_decorator_name:9,token_link_text_wrapper:9,token_link_text:9,token_link_punctuation:9,token_special_keyword:10,token_namespace:10,token_rule:10,token_at_keyword:11,token_url:11,token_strikethrough:13,token_bold:14,token_italic:15},s=()=>!!(globalThis.CSS?.highlights&&globalThis.Highlight),c=()=>typeof globalThis.StaticRange==`function`?`static`:`live`,l=e=>{for(let t of e.childNodes)if(t.nodeType===Node.TEXT_NODE)return t;return null},u=(e,t,n)=>{let r=e.get(t);r?r.push(n):e.set(t,[n])},d=new WeakMap,f=e=>{let t=d.get(e);if(t===void 0){t=[`token_${e.name}`];for(let n of e.aliases)t.push(`token_${n}`);d.set(e,t)}return t},p=class{element_ranges;#e;constructor(){if(!s())throw Error(`CSS Highlights API not supported`);this.element_ranges=new Map,this.#e=c()}highlight_from_lexed(e,t){this.clear_element_ranges();let n=l(e);if(!n){t.events_len>0&&console.error(`[HighlightManager] tokens present but no text node to highlight`);return}try{this.#t(n,t)}catch(e){if(this.#e===`static`)this.#e=`live`,this.clear_element_ranges(),this.#t(n,t);else throw e}}#t(e,t){let n=new Map;this.#r(t,e,n);for(let[e,t]of n){this.element_ranges.set(e,t);let n=CSS.highlights.get(e);n||(n=new Highlight,n.priority=o[e]??0,CSS.highlights.set(e,n));for(let e of t)n.add(e)}}clear_element_ranges(){for(let[e,t]of this.element_ranges){let n=CSS.highlights.get(e);if(n){for(let e of t)n.delete(e);n.size===0&&CSS.highlights.delete(e)}}this.element_ranges.clear()}destroy(){this.clear_element_ranges()}#n(e,t,n){if(this.#e===`static`)return new StaticRange({startContainer:e,startOffset:t,endContainer:e,endOffset:n});let r=new Range;return r.setStart(e,t),r.setEnd(e,n),r}#r(e,t,n){let{events:r,events_len:i}=e,{infos:a}=e.types,o=t.textContent?.length??0,s=[],c=0;for(;c<i;){let e=r[c];if(e>0)this.#i(a[e],r[c+1],r[c+2],t,n,o),c+=3;else if(e<0)s.push({id:-e,start:r[c+1]}),c+=2;else{let e=s.pop();e&&this.#i(a[e.id],e.start,r[c+1],t,n,o),c+=2}}}#i(e,t,n,r,i,a){let o=n>a?a:n;if(o<=t)return;let s=this.#n(r,t,o);for(let t of f(e))u(i,t,s)}},m=i=>{let a=s()?new p:null,o=i.enabled??(()=>!0),c=n(()=>i.lang()!==null&&i.syntax_styler().has_lang(i.lang())),l=n(()=>i.lang()===null||!e(c)),u=n(()=>{if(!a||!o()||e(l))return null;let t=i.text();return t?i.syntax_styler().lex(t,i.lang()):null});return a&&t(()=>{let t=i.element();if(!t||!e(u)){a.clear_element_ranges();return}a.highlight_from_lexed(t,e(u))}),r(()=>a?.destroy()),{get highlighting_disabled(){return e(l)}}};export{i,s as n,a as r,m as t};